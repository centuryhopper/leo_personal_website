...
const languages = [
    ...
    'JavaScript. I have learned this language through using Node.Js for building APIs for managing my own passwords, storing images in the cloud, and general storage purposes for any frontend applications I build. Fun fact, this website was built using Vue.js!',
